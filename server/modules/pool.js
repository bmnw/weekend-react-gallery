...
// this creates the (connection) pool that will be shared by all other modules
const pool = new pg.Pool(config); // allows for simultaneous requests to the database
